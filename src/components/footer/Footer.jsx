...
const Footer = () => {
  return (
    <footer className="relative mt-24 bg-[radial-gradient(ellipse_at_70%_50%,#0f2238_0%,#070f1e_40%,#020508_100%)] ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              />
              <h2 className="text-xl font-semibold tracking-tight dark:text-white text-white">
                pix<span className="text-purple-600">gen</span>
              </h2>
            </div>

            <p className="text-sm leading-relaxed text-gray-200 dark:text-gray-200 max-w-xs">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-200 dark:text-gray-100">
              <li>
                <Link
                  href="/generate"
                  className="hover:text-purple-400 hover:underline dark:hover:text-white transition"
                >
                  Generate
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <Link
              ...
              border text-white dark:bg-white dark:text-black 
